...
<%
    ...
    String organ_level = session.getAttribute("organ_level")==null?"":String.valueOf(session.getAttribute("organ_level"));
%>
...
<script src="${home}/scripts/comm/commonjs_no.js" type="text/javascript"></script>
